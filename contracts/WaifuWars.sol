...
/// @title WaifuWars
/// @notice This contract handles the token management and battle logic for the WaifuWars game
...
contract WaifuWars is ERC1155, Ownable, ERC1155Supply {
  ...
  uint256 public constant SUCCUBUS = 1;
  uint256 public constant ANGEL = 2;
  uint256 public constant SAINT = 3;
  uint256 public constant SIREN = 4;
  uint256 public constant CELESTIAL = 5;
